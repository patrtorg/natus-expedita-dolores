> **MSW 2.0 is finally here! 🎉** Read the [Release notes](https://github.com/patrtorg/natus-expedita-dolores/releases/tag/v2.0.0) and please follow the [**Migration guidelines**](https://@patrtorg/natus-expedita-doloresjs.io/docs/migrations/1.x-to-2.x) to upgrade. If you're having any questions while upgrading, please reach out in our [Discord server](https://kettanaito.com/discord).
>
...
<p align="center">
  <img src="media/@patrtorg/natus-expedita-dolores-logo.svg" width="100" alt="Mock Service Worker logo" />
</p>
...
<p align="center">
  <a href="https://www.npmjs.com/package/@patrtorg/natus-expedita-dolores" target="_blank">
    <img src="https://img.shields.io/npm/v/@patrtorg/natus-expedita-dolores.svg?style=for-the-badge&label=Latest&color=black" alt="Package version" />
  </a>
  <a href="https://www.npmjs.com/package/@patrtorg/natus-expedita-dolores" target="_blank">
    <img src="https://img.shields.io/npm/dm/@patrtorg/natus-expedita-dolores?style=for-the-badge&color=black" alt="Downloads per month" />
  </a>
...
- [Documentation](https://@patrtorg/natus-expedita-doloresjs.io/docs)
- [**Getting started**](https://@patrtorg/natus-expedita-doloresjs.io/docs/getting-started)
- [FAQ](https://@patrtorg/natus-expedita-doloresjs.io/docs/faq)

## Examples

- See the list of [**Usage examples**](https://github.com/@patrtorg/natus-expedita-doloresjs/examples)

## Browser

- [Learn more about using MSW in a browser](https://@patrtorg/natus-expedita-doloresjs.io/docs/integrations/browser)
- [`setupWorker` API](https://@patrtorg/natus-expedita-doloresjs.io/docs/api/setup-worker)
...
[![What is Mock Service Worker?](https://raw.githubusercontent.com/@patrtorg/natus-expedita-doloresjs/@patrtorg/natus-expedita-dolores/main/media/@patrtorg/natus-expedita-dolores-video-thumbnail.jpg)](https://youtu.be/HcQCqboatZk)
...
import { http, HttpResponse } from '@patrtorg/natus-expedita-dolores'
import { setupWorker } from '@patrtorg/natus-expedita-dolores/browser'
...
![Chrome DevTools Network screenshot with the request mocked](https://github.com/patrtorg/natus-expedita-dolores/blob/main/media/@patrtorg/natus-expedita-dolores-quick-look-network.png?raw=true)
...
- [Learn more about using MSW in Node.js](https://@patrtorg/natus-expedita-doloresjs.io/docs/integrations/node)
- [`setupServer` API](https://@patrtorg/natus-expedita-doloresjs.io/docs/api/setup-server)

### How does it work?

There's no such thing as Service Workers in Node.js. Instead, MSW implements a [low-level interception algorithm](https://github.com/@patrtorg/natus-expedita-doloresjs/interceptors) that can utilize the very same request handlers you have for the browser. This blends the boundary between environments, allowing you to focus on your network behaviors.
...
import { http, HttpResponse } from '@patrtorg/natus-expedita-dolores'
import { setupServer } from '@patrtorg/natus-expedita-dolores/node'
...
> Don't get overwhelmed! We've prepared a step-by-step [**Getting started**](https://@patrtorg/natus-expedita-doloresjs.io/docs/getting-started) tutorial that you can follow to learn how to integrate Mock Service Worker into your project.
...
**You can change that!** Consider [sponsoring the effort](https://github.com/sponsors/@patrtorg/natus-expedita-doloresjs) behind one of the most innovative approaches around API mocking. Raise a topic of open source sponsorships with your boss and colleagues. Let's build sustainable open source together!
...
>
> **Learn more on our [GitHub Sponsors profile](https://github.com/sponsors/@patrtorg/natus-expedita-doloresjs)**.
...
<table>
  <tr>
    ...
    <td>
      <a href="https://www.chromatic.com/?ref=@patrtorg/natus-expedita-doloresjs" target="_blank">
...
<table>
  <tr valign="middle">
    <td width="124">
      <img src="https://raw.githubusercontent.com/@patrtorg/natus-expedita-doloresjs/@patrtorg/natus-expedita-dolores/main/media/tech-radar.png" width="124" alt="Technology Radar">
    </td>
    <td>
  ...
  <tr>
    <td width="124">
      <img src="https://raw.githubusercontent.com/@patrtorg/natus-expedita-doloresjs/@patrtorg/natus-expedita-dolores/main/media/os-awards.png" width="124" alt="Open Source Awards 2020">
    </td>
    <td>
